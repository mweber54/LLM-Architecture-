...
const edges = [
  ...
  { id: 'e4', source: 'node-attention1', target: 'node-ffn1', animated: true, markerEnd: { type: 'arrowclosed' } },
  { id: 'e5', source: 'node-ffn1', target: 'node-cot1', animated: true, markerEnd: { type: 'arrowclosed' } },
  // Transition from Block 1 to Block 2
  { id: 'e6', source: 'node-cot1', target: 'node-attention2', animated: true, markerEnd: { type: 'arrowclosed' } },
  { id: 'e7', source: 'node-attention2', target: 'node-ffn2', animated: true, markerEnd: { type: 'arrowclosed' } },
  { id: 'e8', source: 'node-ffn2', target: 'node-cot2', animated: true, markerEnd: { type: 'arrowclosed' } },
  // Merge transformer backbone output
  { id: 'e9', source: 'node-cot2', target: 'node-backbone-output', markerEnd: { type: 'arrowclosed' } },
  { id: 'e10', source: 'node-backbone-output', target: 'node-output', markerEnd: { type: 'arrowclosed' } },
  { id: 'e11', source: 'node-output', target: 'node-alignment', markerEnd: { type: 'arrowclosed' } },
];
